	...
	<div class="card">
		...
		<div class="card-body">
			...
			<div class="card-body-header">
				...
				<p class="card-body-hashtag">#${ sellerList.get(0).get("CATEGORY_NAME") } #경력 ${ sellerList.get(0).get("CAREER") }년</p>
			...
			<p class="card-body-description">
				...
				<label for="comment">자기 소개 :</label>
				<textarea rows="6" cols="50" style="resize: none;" name="contents"></textarea>
			...
			<div class="card-body-footer">
				...
				<label for="comment">프로필 사진 :</label>
				<input type="file" style="float:left" name="upfile" multiple accept=".jpg, .png" >
				
				<br><br>

				<button class="btn btn-primary" style="background-color:rgb(170, 143, 211); border: 1px soild rgb(170, 143, 211); float:right">수정 완료</button>
