...
<body>
	...
	<div class="w3-content w3-container" style="margin-top: 300px; width: 30%;">
		<div class="w3-container w3-card-4">
			...
			<div>
				<h5>
					입력하신 이메일로 가입된 아이디는 <strong>${ id } </strong>입니다.
				</h5>
				<p class="w3-center">
					<button type="button" id=loginBtn class="w3-button w3-block w3-ripple w3-margin-top w3-round" style="background-color:rgb(170, 143, 211); color: white;">로그인</button>
					<button type="button" onclick="history.go(-1);" class="w3-button w3-block w3-ripple w3-margin-top w3-margin-bottom w3-round" style="background-color:rgb(170, 143, 211); color: white;">닫기</button>
				</p>
			</div>
		</div>
	</div>
